...
2. Open the file `pix2grasshopper_main_demo_example.gh` and ensure you have the `descriptions.json` file as well
3. Follow the instructions in the large text panel, and enjoy!
